...
- **STEP 5 · 🗂️ 학습지 활동 (정보 차 · Information Gap)** — 수업 활동지와 직접 연결
  - 활동지 속 **6명**을 그대로 재현: 그림(SVG) + 생김새 힌트 + 문장 수 + 정답 문장
  - 각 인물 **🔨 문장 만들기로 만들기** → 빌더에 바로 불러와 완성 (활동지 지시문 그대로)
  - **🎤 짝 대화 리허설** — 앱이 *"What does he/she look like?"* 라고 물으면 얼굴을 보고
    영어로 묘사(마이크 채점). 실제로 친구와 정보 차 활동을 하기 전 연습
  - 활동지 필수 어휘 **shirt(셔츠)·색깔 안경**까지 포함해 6명 문장을 모두 만들 수 있어요
